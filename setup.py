...
data_files.append('cb-virustotal-connector.spec')
data_files.append('scripts/cb-virustotal-connector')
scripts = {
    'cb-virustotal-connector': {
        'spec': 'cb-virustotal-connector.spec',
        'dest': '/usr/share/cb/integrations/virustotal/bin/'
    }
}

setup(
    name='python-cb-virustotal-connector',
    version='1.0',
    packages=['cbopensource', 'cbopensource.connectors', 'cbopensource.connectors.virustotal'],
    url='https://github.com/carbonblack/cb-virustotal-connector',
    license='MIT',
    author='Carbon Black Developer Network',
    author_email='dev-support@carbonblack.com',
    description=
        'Connector between Carbon Black and Virus Total',
